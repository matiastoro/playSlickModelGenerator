...
class HelicopterLandingAreaController @Inject()(cc: MessagesControllerComponents)(implicit val repo: HelicopterLandingAreaRepository, aerodromeRepo: AerodromeRepository, ec: ExecutionContext) extends MessagesAbstractController(cc) with Autorization {

/*
GET         /helicopterLandingArea/                  controllers.HelicopterLandingAreaController.index(page: Int = 1, pageLength: Int = 20)
...
GET         /helicopterLandingArea/:page/:pageLength controllers.HelicopterLandingAreaController.index(page: Int, pageLength: Int)
GET         /helicopterLandingArea/:page             controllers.HelicopterLandingAreaController.index(page: Int, pageLength: Int = 20)
*/
  ...
  val filterForm = HelicopterLandingAreaForm.filterForm
  ...
  def options() = withUserAsync{ user =>  implicit request =>
    for{
      aerodromes <- aerodromeRepo.getAll
        ...
        Ok(Json.obj("aerodromes" -> Json.toJson(aerodromes)))
      }
