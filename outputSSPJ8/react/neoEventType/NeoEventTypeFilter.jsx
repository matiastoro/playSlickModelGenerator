...
export default class NeoEventTypeFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["eventType"] = input}  name="eventType" fullWidth defaultValue={this.getAttr(obj, "eventType", "")} floatingLabelText="Event Type" readOnly={readOnly}  errors={this.getAttr(errors, "eventType")}/>
                </Col>
            </Row>
        </div>
    }
