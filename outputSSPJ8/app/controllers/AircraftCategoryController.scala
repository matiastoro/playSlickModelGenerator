...
/*
GET         /aircraftCategory/                  controllers.AircraftCategoryController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /aircraftCategory/:page/:pageLength/:sortColumn/:sortOrder controllers.AircraftCategoryController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /aircraftCategory/:page/:pageLength controllers.AircraftCategoryController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /aircraftCategory/:page             controllers.AircraftCategoryController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = AircraftCategoryFilterForm.filterForm
