...
case class AerodromeTypeFilter(id: Option[Long] = None,
                               tpe: Option[String] = None)

object AerodromeTypeFilter {
  val tupled = (this.apply _).tupled
}


object AerodromeTypeFilterForm{
  
  val filterForm = Form(
            mapping(
      "id" -> optional(longNumber),
      "tpe" -> optional(nonEmptyText)
    )/*(AerodromeTypeFilter.apply)(AerodromeTypeFilter.unapply)*/
    ((id,tpe) => {
      AerodromeTypeFilter(id, tpe)
    })((formData: AerodromeTypeFilter) => {
