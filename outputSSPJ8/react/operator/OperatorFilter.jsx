...
export default class OperatorFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["operator"] = input}  name="operator" fullWidth defaultValue={this.getAttr(obj, "operator", "")} floatingLabelText="Operator" readOnly={readOnly}  errors={this.getAttr(errors, "operator")}/>
                </Col>
                <Col xs={6} sm={2}>
