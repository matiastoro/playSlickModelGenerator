...
case class NeoAerodromeOcurrenceCategoryFilter(id: Option[Long] = None,
                                               neoAerodromeId: Option[Long] = None,
                                               ocurrenceCategoryId: Option[Long] = None)

object NeoAerodromeOcurrenceCategoryFilter {
  val tupled = (this.apply _).tupled
}


object NeoAerodromeOcurrenceCategoryFilterForm{
  ...
  val filterForm = Form(
    ...
    )/*(NeoAerodromeOcurrenceCategoryFilter.apply)(NeoAerodromeOcurrenceCategoryFilter.unapply)*/
    ((id,neoAerodromeId,ocurrenceCategoryId) => {
      NeoAerodromeOcurrenceCategoryFilter(id, neoAerodromeId, ocurrenceCategoryId)
    })((formData: NeoAerodromeOcurrenceCategoryFilter) => {
      Some((formData.id, formData.neoAerodromeId, formData.ocurrenceCategoryId))
    })
  )
}
