...
export default class FlightRuleFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["flightRule"] = input}  name="flightRule" fullWidth defaultValue={this.getAttr(obj, "flightRule", "")} floatingLabelText="Flight Rule" readOnly={readOnly}  errors={this.getAttr(errors, "flightRule")}/>
                </Col>
            </Row>
        </div>
    }
