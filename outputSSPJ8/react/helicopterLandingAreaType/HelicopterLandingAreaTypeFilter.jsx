    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["tpe"] = input}  name="tpe" fullWidth defaultValue={this.getAttr(obj, "tpe", "")} floatingLabelText="Tpe" readOnly={readOnly}  errors={this.getAttr(errors, "tpe")}/>
                </Col>
            </Row>
        </div>
    }
