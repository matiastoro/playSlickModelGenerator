...
case class Window(id: Option[Long] = None /*None*/,
                  branchId: Long = 0 /*None*/,
                  window: String = "" /*None*/) extends WindowExtension{
