...
/*
GET         /neoFlightOperation/                  controllers.NeoFlightOperationController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /neoFlightOperation/:page/:pageLength/:sortColumn/:sortOrder controllers.NeoFlightOperationController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /neoFlightOperation/:page/:pageLength controllers.NeoFlightOperationController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /neoFlightOperation/:page             controllers.NeoFlightOperationController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = NeoFlightOperationFilterForm.filterForm
