...
export default class ProfileForm extends GForm{
    ...
    renderForm(obj, errors){
        ...
        return <div>
          ...
          <div>
            <TextField ref={(input) => this._inputs["profile"] = input}  name="profile" defaultValue={this.getAttr(obj, "profile", "")} floatingLabelText="Profile" readOnly={readOnly} required={true} errors={this.getAttr(errors, "profile")}/>
          </div>
        </div>
    }
