...
/*
GET         /weatherCondition/                  controllers.WeatherConditionController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /weatherCondition/:page/:pageLength/:sortColumn/:sortOrder controllers.WeatherConditionController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /weatherCondition/:page/:pageLength controllers.WeatherConditionController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /weatherCondition/:page             controllers.WeatherConditionController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = WeatherConditionFilterForm.filterForm
