    ...
    renderFilter(){
        ...
        return <div>
            ...
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <SelectField ref={(input) => this._inputs["aircraftDescription.landingGearTypeId"] = input}  name="aircraftDescription.landingGearTypeId" fullWidth defaultValue={this.getAttr(obj, "aircraftDescription.landingGearTypeId", "")} options={this.getOptions(options.aircraftLandingGearTypes.map(o => {return {"value": o.id, "label": o.landingGearType, "parentId": o.aircraftLandingGearTypeId}}))} floatingLabelText="Landing Gear Type Id" readOnly={readOnly}  errors={this.getAttr(errors, "aircraftDescription.landingGearTypeId")} />
                </Col>
                <Col xs={6} sm={2}>
