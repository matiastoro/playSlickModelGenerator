...
CREATE INDEX "helicopter_landing_area_helicopter_landing_area_type_id_idx"
  ON "helicopter_landing_area"
  USING btree
  ("helicopter_landing_area_type_id");

CREATE INDEX "helicopter_landing_area_helicopter_landing_area_area_configuration_id_idx"
  ON "helicopter_landing_area"
  USING btree
  ("helicopter_landing_area_area_configuration_id");

CREATE INDEX "helicopter_landing_area_helicopter_landing_area_surface_type_id_idx"
  ON "helicopter_landing_area"
  USING btree
...
ALTER TABLE IF EXISTS "helicopter_landing_area" ADD CONSTRAINT "helicopter_landing_area_aerodrome_fk_1" FOREIGN KEY ("aerodrome_id")
  REFERENCES "aerodrome" ("id") MATCH SIMPLE
  ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE IF EXISTS "helicopter_landing_area" ADD CONSTRAINT "helicopter_landing_area_helicopter_landing_area_type_fk_1" FOREIGN KEY ("helicopter_landing_area_type_id")
  REFERENCES "helicopter_landing_area_type" ("id") MATCH SIMPLE
  ON UPDATE NO ACTION ON DELETE SET NULL;
ALTER TABLE IF EXISTS "helicopter_landing_area" ADD CONSTRAINT "helicopter_landing_area_helicopter_landing_area_area_configuration_fk_1" FOREIGN KEY ("helicopter_landing_area_area_configuration_id")
  REFERENCES "helicopter_landing_area_area_configuration" ("id") MATCH SIMPLE
  ON UPDATE NO ACTION ON DELETE SET NULL;
ALTER TABLE IF EXISTS "helicopter_landing_area" ADD CONSTRAINT "helicopter_landing_area_helicopter_landing_area_surface_type_fk_1" FOREIGN KEY ("helicopter_landing_area_surface_type_id")
...
ALTER TABLE IF EXISTS "helicopter_landing_area" DROP CONSTRAINT IF EXISTS  "helicopter_landing_area_helicopter_landing_area_surface_type_fk_1";
ALTER TABLE IF EXISTS "helicopter_landing_area" DROP CONSTRAINT IF EXISTS  "helicopter_landing_area_helicopter_landing_area_area_configuration_fk_1";
ALTER TABLE IF EXISTS "helicopter_landing_area" DROP CONSTRAINT IF EXISTS  "helicopter_landing_area_helicopter_landing_area_type_fk_1";
...
DROP INDEX IF EXISTS "helicopter_landing_area_helicopter_landing_area_type_id_idx";
DROP INDEX IF EXISTS "helicopter_landing_area_helicopter_landing_area_area_configuration_id_idx";
DROP INDEX IF EXISTS "helicopter_landing_area_helicopter_landing_area_surface_type_id_idx";
