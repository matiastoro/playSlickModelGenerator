...
export default class AerodromeStatusFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["status"] = input}  name="status" fullWidth defaultValue={this.getAttr(obj, "status", "")} floatingLabelText="Status" readOnly={readOnly}  errors={this.getAttr(errors, "status")}/>
                </Col>
            </Row>
        </div>
    }
