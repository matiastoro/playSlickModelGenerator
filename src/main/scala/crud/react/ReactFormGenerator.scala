...
case class ReactFormGenerator(table: Table, submodulePackageString: String) extends CodeGenerator{
...
export default class ${table.className}Form extends React.Component{
    constructor(props){
        super(props);
    }
    render(){
