...
import {DepartamentoUsuarioFormInline} from '../departamentoUsuario/DepartamentoUsuarioForm'
import {UsuarioTipoInspectorFormInline} from '../usuarioTipoInspector/UsuarioTipoInspectorForm'
    ...
    renderForm(obj, errors){
        ...
        return <div>
          ...
          <div>
            ...
            <GNestedForms ref={(i) => this._inputs["departamentoUsuarios"] = i} description="DepartamentoUsuarios" prefix="departamentoUsuarios" readOnly={readOnly} objs={obj.departamentoUsuarios} renderNested={(nobj, k, refFunc) => <DepartamentoUsuarioFormInline i={k} obj={Object.assign({usuarioId: obj.id},nobj)} ref={(input) => refFunc(input)} readOnly={readOnly} hide={["usuarioId"]} errors={errors} prefix="departamentoUsuarios"/>}/>
            <GNestedForms ref={(i) => this._inputs["usuarioTipoInspectors"] = i} description="UsuarioTipoInspectors" prefix="usuarioTipoInspectors" readOnly={readOnly} objs={obj.usuarioTipoInspectors} renderNested={(nobj, k, refFunc) => <UsuarioTipoInspectorFormInline i={k} obj={Object.assign({usuarioId: obj.id},nobj)} ref={(input) => refFunc(input)} readOnly={readOnly} hide={["usuarioId"]} errors={errors} prefix="usuarioTipoInspectors"/>}/>
        </div>
    }
