...
case class HelicopterLandingAreaType(id: Option[Long] = None /*None*/,
                                     tpe: String = "" /*None*/) extends HelicopterLandingAreaTypeExtension{
...
object HelicopterLandingAreaTypeForm{
  ...
  val form = Form(
    ...
    ((id,tpe) => {
      HelicopterLandingAreaTypeFormData(HelicopterLandingAreaType(id, tpe))
...
case class HelicopterLandingAreaTypeFilter(id: Option[Long] = None,
                                           tpe: Option[String] = None)

object HelicopterLandingAreaTypeFilter {
  val tupled = (this.apply _).tupled
}


object HelicopterLandingAreaTypeFilterForm{
  
  val filterForm = Form(
            mapping(
      "id" -> optional(longNumber),
      "tpe" -> optional(nonEmptyText)
    )/*(HelicopterLandingAreaTypeFilter.apply)(HelicopterLandingAreaTypeFilter.unapply)*/
    ((id,tpe) => {
      HelicopterLandingAreaTypeFilter(id, tpe)
    })((formData: HelicopterLandingAreaTypeFilter) => {
      Some((formData.id, formData.tpe))
    })
  )
}
