    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <SelectField ref={(input) => this._inputs["aircraftLandingGearTypeId"] = input}  name="aircraftLandingGearTypeId" fullWidth defaultValue={this.getAttr(obj, "aircraftLandingGearTypeId", "")} options={this.getOptions(options.aircraftLandingGearTypes.map(o => {return {"value": o.id, "label": o.landingGearType, "parentId": o.aircraftLandingGearTypeId}}))} floatingLabelText="Aircraft Landing Gear Type Id" readOnly={readOnly}  errors={this.getAttr(errors, "aircraftLandingGearTypeId")} />
                </Col>
            </Row>
        </div>
    }
