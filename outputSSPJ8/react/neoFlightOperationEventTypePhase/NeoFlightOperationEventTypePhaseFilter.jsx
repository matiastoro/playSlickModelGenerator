    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <SelectField ref={(input) => this._inputs["neoFlightOperationId"] = input}  name="neoFlightOperationId" fullWidth defaultValue={this.getAttr(obj, "neoFlightOperationId", "")} options={this.getOptions(options.neoFlightOperations.map(o => {return {"value": o.id, "label": o.neoFlightOperation, "parentId": o.neoFlightOperationId}}))} floatingLabelText="Neo Flight Operation Id" readOnly={readOnly}  errors={this.getAttr(errors, "neoFlightOperationId")} />
                </Col>
                <Col xs={6} sm={2}>
                    <SelectField ref={(input) => this._inputs["neoEventTypeId"] = input}  name="neoEventTypeId" fullWidth defaultValue={this.getAttr(obj, "neoEventTypeId", "")} options={this.getOptions(options.neoEventTypes.map(o => {return {"value": o.id, "label": o.eventType, "parentId": o.neoEventTypeId}}))} floatingLabelText="Neo Event Type Id" readOnly={readOnly}  errors={this.getAttr(errors, "neoEventTypeId")} />
                </Col>
                <Col xs={6} sm={2}>
                    <SelectField ref={(input) => this._inputs["phaseId"] = input}  name="phaseId" fullWidth defaultValue={this.getAttr(obj, "phaseId", "")} options={this.getOptions(options.phases.map(o => {return {"value": o.id, "label": o.phase, "parentId": o.phaseId}}))} floatingLabelText="Phase Id" readOnly={readOnly}  errors={this.getAttr(errors, "phaseId")} />
                </Col>
            </Row>
        </div>
    }
...
export class NeoFlightOperationEventTypePhaseFormInline extends GFormInline{
    ...
    renderForm(){
        ...
        return <div>
<TextField ref={(input) => this._inputs["id"] = input}  name="id" fullWidth defaultValue={this.getAttr(obj, "id", "")} floatingLabelText="Id" readOnly={readOnly}  errors={this.getAttr(errors, "id")}/>
<SelectField ref={(input) => this._inputs["neoFlightOperationId"] = input}  name="neoFlightOperationId" fullWidth defaultValue={this.getAttr(obj, "neoFlightOperationId", "")} options={this.getOptions(options.neoFlightOperations.map(o => {return {"value": o.id, "label": o.neoFlightOperation, "parentId": o.neoFlightOperationId}}))} floatingLabelText="Neo Flight Operation Id" readOnly={readOnly}  errors={this.getAttr(errors, this.props.prefix+"["+i+"].neoFlightOperationId", "")} />
<SelectField ref={(input) => this._inputs["neoEventTypeId"] = input}  name="neoEventTypeId" fullWidth defaultValue={this.getAttr(obj, "neoEventTypeId", "")} options={this.getOptions(options.neoEventTypes.map(o => {return {"value": o.id, "label": o.eventType, "parentId": o.neoEventTypeId}}))} floatingLabelText="Neo Event Type Id" readOnly={readOnly}  errors={this.getAttr(errors, this.props.prefix+"["+i+"].neoEventTypeId", "")} />
<SelectField ref={(input) => this._inputs["phaseId"] = input}  name="phaseId" fullWidth defaultValue={this.getAttr(obj, "phaseId", "")} options={this.getOptions(options.phases.map(o => {return {"value": o.id, "label": o.phase, "parentId": o.phaseId}}))} floatingLabelText="Phase Id" readOnly={readOnly}  errors={this.getAttr(errors, this.props.prefix+"["+i+"].phaseId", "")} />
        </div>
    }
