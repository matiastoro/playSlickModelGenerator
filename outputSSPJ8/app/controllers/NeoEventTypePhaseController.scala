...
/*
GET         /neoEventTypePhase/                  controllers.NeoEventTypePhaseController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /neoEventTypePhase/:page/:pageLength/:sortColumn/:sortOrder controllers.NeoEventTypePhaseController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /neoEventTypePhase/:page/:pageLength controllers.NeoEventTypePhaseController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /neoEventTypePhase/:page             controllers.NeoEventTypePhaseController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = NeoEventTypePhaseFilterForm.filterForm
