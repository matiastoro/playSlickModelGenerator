...
export default class AircraftManufacturerModelList extends GList{
    ...
    renderSecondaryText = (obj) => {
        return <p>
            {obj.aircraftManufacturerModelId && this.state.indexedOptions?this.state.indexedOptions.aircraftManufacturerModels[obj.aircraftManufacturerModelId].manufacturerModel:null}
        </p>
    }
