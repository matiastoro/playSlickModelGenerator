...
/*
GET         /operatorType/                  controllers.OperatorTypeController.index(page: Int = 1, pageLength: Int = 20)
...
GET         /operatorType/:page/:pageLength controllers.OperatorTypeController.index(page: Int, pageLength: Int)
GET         /operatorType/:page             controllers.OperatorTypeController.index(page: Int, pageLength: Int = 20)
*/
  ...
  val filterForm = OperatorTypeForm.filterForm
