...
export default class InjuryLevelFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["injuryLevel"] = input}  name="injuryLevel" fullWidth defaultValue={this.getAttr(obj, "injuryLevel", "")} floatingLabelText="Injury Level" readOnly={readOnly}  errors={this.getAttr(errors, "injuryLevel")}/>
                </Col>
            </Row>
        </div>
    }
