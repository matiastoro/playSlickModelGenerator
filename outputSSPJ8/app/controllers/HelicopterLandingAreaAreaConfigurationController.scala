...
/*
GET         /helicopterLandingAreaAreaConfiguration/                  controllers.HelicopterLandingAreaAreaConfigurationController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /helicopterLandingAreaAreaConfiguration/:page/:pageLength/:sortColumn/:sortOrder controllers.HelicopterLandingAreaAreaConfigurationController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /helicopterLandingAreaAreaConfiguration/:page/:pageLength controllers.HelicopterLandingAreaAreaConfigurationController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /helicopterLandingAreaAreaConfiguration/:page             controllers.HelicopterLandingAreaAreaConfigurationController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = HelicopterLandingAreaAreaConfigurationFilterForm.filterForm
