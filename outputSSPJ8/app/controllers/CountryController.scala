...
class CountryController @Inject()(cc: MessagesControllerComponents)(implicit repo: CountryRepository, ec: ExecutionContext) extends MessagesAbstractController(cc) with Autorization {
...
GET         /country/options             controllers.CountryController.options()
