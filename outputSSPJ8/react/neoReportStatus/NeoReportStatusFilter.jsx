...
export default class NeoReportStatusFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["reportStatus"] = input}  name="reportStatus" fullWidth defaultValue={this.getAttr(obj, "reportStatus", "")} floatingLabelText="Report Status" readOnly={readOnly}  errors={this.getAttr(errors, "reportStatus")}/>
                </Col>
            </Row>
        </div>
    }
