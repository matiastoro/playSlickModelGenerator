...
export default class LanguageFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["language"] = input}  name="language" fullWidth defaultValue={this.getAttr(obj, "language", "")} floatingLabelText="Language" readOnly={readOnly}  errors={this.getAttr(errors, "language")}/>
                </Col>
            </Row>
        </div>
    }
