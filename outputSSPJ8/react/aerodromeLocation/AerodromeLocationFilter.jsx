...
export default class AerodromeLocationFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["location"] = input}  name="location" fullWidth defaultValue={this.getAttr(obj, "location", "")} floatingLabelText="Location" readOnly={readOnly}  errors={this.getAttr(errors, "location")}/>
                </Col>
            </Row>
        </div>
    }
