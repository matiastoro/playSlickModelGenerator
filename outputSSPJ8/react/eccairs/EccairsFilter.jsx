    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <DateTime ref={(input) => this._inputs["date"] = input}  name="date" fullWidth defaultValue={this.getAttr(obj, "date")} floatingLabelText="Date" readOnly={readOnly}  errors={this.getAttr(errors, "date")} />
                </Col>
                <Col xs={6} sm={2}>
