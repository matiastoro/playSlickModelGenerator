...
/*
GET         /neoFlightOperationOcurrenceCategory/                  controllers.NeoFlightOperationOcurrenceCategoryController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /neoFlightOperationOcurrenceCategory/:page/:pageLength/:sortColumn/:sortOrder controllers.NeoFlightOperationOcurrenceCategoryController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /neoFlightOperationOcurrenceCategory/:page/:pageLength controllers.NeoFlightOperationOcurrenceCategoryController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /neoFlightOperationOcurrenceCategory/:page             controllers.NeoFlightOperationOcurrenceCategoryController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = NeoFlightOperationOcurrenceCategoryFilterForm.filterForm
