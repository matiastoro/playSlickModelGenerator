...
/*
GET         /licenseType/                  controllers.LicenseTypeController.index(page: Int = 1, pageLength: Int = 20)
...
GET         /licenseType/:page/:pageLength controllers.LicenseTypeController.index(page: Int, pageLength: Int)
GET         /licenseType/:page             controllers.LicenseTypeController.index(page: Int, pageLength: Int = 20)
*/
  ...
  val filterForm = LicenseTypeForm.filterForm
