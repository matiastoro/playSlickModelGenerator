...
case class HelicopterLandingAreaAreaTypeFilter(id: Option[Long] = None,
...
object HelicopterLandingAreaAreaTypeFilter {
  val tupled = (this.apply _).tupled
}


object HelicopterLandingAreaAreaTypeFilterForm{
  ...
  val filterForm = Form(
    ...
    )/*(HelicopterLandingAreaAreaTypeFilter.apply)(HelicopterLandingAreaAreaTypeFilter.unapply)*/
    ((id,helicopterLandingArea,helicopterLandingAreaTypeId,helicopterLandingAreaAreaConfigurationId,helicopterLandingAreaSurfaceTypeId) => {
      HelicopterLandingAreaAreaTypeFilter(id, helicopterLandingArea, helicopterLandingAreaTypeId, helicopterLandingAreaAreaConfigurationId, helicopterLandingAreaSurfaceTypeId)
    })((formData: HelicopterLandingAreaAreaTypeFilter) => {
      Some((formData.id, formData.helicopterLandingArea, formData.helicopterLandingAreaTypeId, formData.helicopterLandingAreaAreaConfigurationId, formData.helicopterLandingAreaSurfaceTypeId))
    })
  )
}
