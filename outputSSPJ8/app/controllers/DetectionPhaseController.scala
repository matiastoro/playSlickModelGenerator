...
/*
GET         /detectionPhase/                  controllers.DetectionPhaseController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /detectionPhase/:page/:pageLength/:sortColumn/:sortOrder controllers.DetectionPhaseController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /detectionPhase/:page/:pageLength controllers.DetectionPhaseController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /detectionPhase/:page             controllers.DetectionPhaseController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = DetectionPhaseFilterForm.filterForm
