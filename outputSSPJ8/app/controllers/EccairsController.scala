...
/*
GET         /eccairs/                  controllers.EccairsController.index(page: Int = 1, pageLength: Int = 20)
...
GET         /eccairs/:page/:pageLength controllers.EccairsController.index(page: Int, pageLength: Int)
GET         /eccairs/:page             controllers.EccairsController.index(page: Int, pageLength: Int = 20)
*/
  ...
  val filterForm = EccairsForm.filterForm
