...
/*
GET         /aircraftMassGroup/                  controllers.AircraftMassGroupController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /aircraftMassGroup/:page/:pageLength/:sortColumn/:sortOrder controllers.AircraftMassGroupController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /aircraftMassGroup/:page/:pageLength controllers.AircraftMassGroupController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /aircraftMassGroup/:page             controllers.AircraftMassGroupController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = AircraftMassGroupFilterForm.filterForm
