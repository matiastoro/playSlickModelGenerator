...
export default class AircraftMassGroupFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["massGroup"] = input}  name="massGroup" fullWidth defaultValue={this.getAttr(obj, "massGroup", "")} floatingLabelText="Mass Group" readOnly={readOnly}  errors={this.getAttr(errors, "massGroup")}/>
                </Col>
            </Row>
        </div>
    }
