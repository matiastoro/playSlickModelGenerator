...
/*
GET         /neoAerodromeOcurrenceCategory/                  controllers.NeoAerodromeOcurrenceCategoryController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /neoAerodromeOcurrenceCategory/:page/:pageLength/:sortColumn/:sortOrder controllers.NeoAerodromeOcurrenceCategoryController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /neoAerodromeOcurrenceCategory/:page/:pageLength controllers.NeoAerodromeOcurrenceCategoryController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /neoAerodromeOcurrenceCategory/:page             controllers.NeoAerodromeOcurrenceCategoryController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = NeoAerodromeOcurrenceCategoryFilterForm.filterForm
