...
export default class OrganizationFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["organization"] = input}  name="organization" fullWidth defaultValue={this.getAttr(obj, "organization", "")} floatingLabelText="Organization" readOnly={readOnly}  errors={this.getAttr(errors, "organization")}/>
                </Col>
            </Row>
        </div>
    }
