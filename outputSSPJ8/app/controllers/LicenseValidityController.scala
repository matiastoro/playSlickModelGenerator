...
/*
GET         /licenseValidity/                  controllers.LicenseValidityController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /licenseValidity/:page/:pageLength/:sortColumn/:sortOrder controllers.LicenseValidityController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /licenseValidity/:page/:pageLength controllers.LicenseValidityController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /licenseValidity/:page             controllers.LicenseValidityController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = LicenseValidityFilterForm.filterForm
