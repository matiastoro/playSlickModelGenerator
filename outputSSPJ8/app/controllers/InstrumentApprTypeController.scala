...
/*
GET         /instrumentApprType/                  controllers.InstrumentApprTypeController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /instrumentApprType/:page/:pageLength/:sortColumn/:sortOrder controllers.InstrumentApprTypeController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /instrumentApprType/:page/:pageLength controllers.InstrumentApprTypeController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /instrumentApprType/:page             controllers.InstrumentApprTypeController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = InstrumentApprTypeFilterForm.filterForm
