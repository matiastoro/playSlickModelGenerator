...
export default class TrafficTypeFilter extends GFilter{
    ...
    renderFilter(){
        ...
        return <div>
            <Row>
                ...
                <Col xs={6} sm={2}>
                    <TextField ref={(input) => this._inputs["trafficType"] = input}  name="trafficType" fullWidth defaultValue={this.getAttr(obj, "trafficType", "")} floatingLabelText="Traffic Type" readOnly={readOnly}  errors={this.getAttr(errors, "trafficType")}/>
                </Col>
            </Row>
        </div>
    }
