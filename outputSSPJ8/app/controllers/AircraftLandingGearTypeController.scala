...
/*
GET         /aircraftLandingGearType/                  controllers.AircraftLandingGearTypeController.index(page: Int = 1, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
...
GET         /aircraftLandingGearType/:page/:pageLength/:sortColumn/:sortOrder controllers.AircraftLandingGearTypeController.index(page: Int, pageLength: Int, sortColumn: String, sortOrder: String)
GET         /aircraftLandingGearType/:page/:pageLength controllers.AircraftLandingGearTypeController.index(page: Int, pageLength: Int, sortColumn: String = "id", sortOrder: String = "desc")
GET         /aircraftLandingGearType/:page             controllers.AircraftLandingGearTypeController.index(page: Int, pageLength: Int = 20, sortColumn: String = "id", sortOrder: String = "desc")
*/
  ...
  val filterForm = AircraftLandingGearTypeFilterForm.filterForm
